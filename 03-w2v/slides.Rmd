...
1.  Replace single words with "phrases" (ngrams)
2.  We have a bag of ngrams
3.  Repeat word2vec...

...if supervised

4.  Add layer for output

## 4. CNN

Architecture:

1.  Add convolution filter (1 dimension)
2.  Pooling? (yes/no)
3.  Add dense layer to output
